    ...
    <>
      ...
      >
        ...
        <div
          ...
          className={`absolute right-0 bottom-0 w-full md:w-[400px] h-[85vh] md:h-full bg-base-bg md:border-l border-t md:border-t-0 border-base-border shadow-2xl flex flex-col transition-transform duration-300 ease-out transform ${
            isOpen
